...
import { InputSelect } from '@/core/_shared/components/input-select'
import { InputText } from '@/core/_shared/components/input-text'
import { Pagination } from '@/core/_shared/components/shared/pagination'
