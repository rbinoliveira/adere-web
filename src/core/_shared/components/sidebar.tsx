...
import { PRIMITIVE, UI } from '@/core/_shared/components'
import { ButtonProps } from '@/core/_shared/components/button'
import { SidebarContentNav } from '@/core/_shared/components/shared/sidebar-content-nav'
import { SidebarUserInfo } from '@/core/_shared/components/shared/sidebar-user-info'
import { getCompoundName } from '@/core/_shared/helpers/name-manipulator.helper'
import { useIsMobile } from '@/core/_shared/helpers/use-mobile'
import { cn } from '@/core/_shared/libs/tw-merge'
import { deleteAuthCookies } from '@/core/auth/helpers/delete-auth-cookies.helper'
import { useAuth } from '@/core/auth/hooks/auth.hook'
  ...
  return (
    <header className="border-border-one bg-background flex h-[80px] w-full items-center justify-end border-b pr-8 transition-[width,height] ease-linear">
      ...
      <PRIMITIVE.DropdownMenu
        ...
        items={[
          <button key="logout" onClick={deleteAuthCookies}>
            Sair
          </button>,
        ]}
      />
